...
const WEDDING_DATE = new Date('2026-06-20T12:30:00').getTime();
    ...
    if (distance <= 0) {
        if (!window.celebrationStarted) {
            ...
            announcement.innerHTML = `
                ...
                <h2 class="section-title" style=" font-family: 'Cormorant Garamond', serif; color: #ffffff; border: none; margin-bottom: 1rem;">Tony & Anupama</h2>
